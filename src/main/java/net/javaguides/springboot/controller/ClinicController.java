...
public class ClinicController {
	...
	@PutMapping("/account/{accountId}/{clinicId}")
	public ResponseEntity<Clinic> addClinicAccount(@PathVariable("accountId") long accountId,
			@PathVariable("clinicId") long clinicId) {
		return new ResponseEntity<Clinic>(clinicService.addClinicAccount(accountId, clinicId), HttpStatus.OK);
	}
